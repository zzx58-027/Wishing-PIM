/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b09abfa9de326d569d8fa085dde4990d)
// Runtime types generated with workerd@1.20250816.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		CLOUDFLARE_ACCOUNT_ID: string;
		POOLE_FTP_LOGIN_BASIC_AUTH: string;
		INNGEST_DEV: string;
		INNGEST_BASE_URL: string;
		INNGEST_SIGNING_KEY: string;
		INNGEST_EVENT_KEY: string;
		VOLCENGINE_AI_API_KEY: string;
		VOLCENGINE_AI_BASE_URL: string;
		VOLCENGINE_AI_BASE_URL_BOT: string;
		R2_TEMP_CDN_BASE_URL: string;
		LLAMACLOUD_API_KEY: string;
		R2_Main: R2Bucket;
		R2_Temp: R2Bucket;
		Label_Studio: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "POOLE_FTP_LOGIN_BASIC_AUTH" | "INNGEST_DEV" | "INNGEST_BASE_URL" | "INNGEST_SIGNING_KEY" | "INNGEST_EVENT_KEY" | "VOLCENGINE_AI_API_KEY" | "VOLCENGINE_AI_BASE_URL" | "VOLCENGINE_AI_BASE_URL_BOT" | "R2_TEMP_CDN_BASE_URL" | "LLAMACLOUD_API_KEY">> {}
}
