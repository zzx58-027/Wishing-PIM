/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9ad0d03626b518d14f7db5971407daff)
...
declare namespace Cloudflare {
	interface Env {
		...
		INNGEST_EVENT_URL: string;
		R2_TEMP_BUCKET: string;
		R2_MAIN_BUCKET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POOLE_FTP_LOGIN_BASIC_AUTH" | "INNGEST_SIGNING_KEY" | "INNGEST_EVENT_KEY" | "INNGEST_DEV" | "INNGEST_BASE_URL" | "INNGEST_EVENT_URL" | "R2_TEMP_BUCKET" | "R2_MAIN_BUCKET" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
